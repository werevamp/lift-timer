...
export function useTheme() {
  ...
  return {
    ...
    isDark:
      context.theme === 'dark' || (context.theme === 'system' && context.systemTheme === 'dark'),
...
export function useThemeStyles<T extends Record<string, any>>(lightStyles: T, darkStyles: T): T {
